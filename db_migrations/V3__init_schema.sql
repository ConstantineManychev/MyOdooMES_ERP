...
ADD CONSTRAINT uniq_event_time_machine_tag UNIQUE (time, machine_name, tag_name);

ALTER TABLE telemetry_count 
ADD CONSTRAINT uniq_count_time_machine_tag UNIQUE (time, machine_name, tag_name);